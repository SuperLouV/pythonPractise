...
def get_xiju_url_list():
       ...
       base_url8 = "https://movie.douban.com/j/chart/top_list?type=24&interval_id=100%3A90&action=&start={}&limit=20"  # 100-90的影片   完成
       base_url9 = "https://movie.douban.com/j/chart/top_list?type=24&interval_id=90%3A80&action=&start={}&limit=20"  # 完成
       base_url10 = "https://movie.douban.com/j/chart/top_list?type=24&interval_id=80%3A70&action=&start={}&limit=20"  # 80-70的影片
       base_url1 = "https://movie.douban.com/j/chart/top_list?type=24&interval_id=70%3A60&action=&start={}&limit=20"
       base_url2 = "https://movie.douban.com/j/chart/top_list?type=24&interval_id=60%3A50&action=&start={}&limit=20"
       base_url3 = "https://movie.douban.com/j/chart/top_list?type=24&interval_id=50%3A40&action=&start={}&limit=20"
       base_url4 = "https://movie.douban.com/j/chart/top_list?type=24&interval_id=40%3A30&action=&start={}&limit=20"
       base_url5 = "https://movie.douban.com/j/chart/top_list?type=24&interval_id=30%3A20&action=&start={}&limit=20"
       base_url6= "https://movie.douban.com/j/chart/top_list?type=24&interval_id=20%3A10&action=&start={}&limit=20"
       base_url7 = "https://movie.douban.com/j/chart/top_list?type=24&interval_id=10%3A0&action=&start={}&limit=20"
       base_url = [base_url1, base_url2, base_url3, base_url4, base_url5, base_url6, base_url7, base_url8, base_url9,
                   base_url10, ]
       # print(base_url)
       num = 0
       xiju_Movie = []
       while num <= 440:  # num从0 意味着一共20部电影,一般都是每个段位460多电影
           try:
               i = 0
               while i <= 6:  # 第1次设置为2
                   try:
                       ...
                       print(html)
                       dict_xiju = json.loads(html_str)  # 先把对象转换为json才可以操作
                       print(type(dict_xiju))  # 判断类型  list类型。每个list[]里面都是一个字典
                       xiju_Movie = xiju_Movie + dict_xiju
                       print(len(xiju_Movie))

                       for xiju in dict_xiju:
                           print(xiju, "\n")
                       # 输出电影信息
                       print("第", i, "轮爬虫")
                   except:
       ...
       url_dict_xiju = []
       title_dict_xiju = []
       # print(type(xiju_Movie[2]))
       while j_num < len(xiju_Movie):
           dict = xiju_Movie[j_num]
           # url_dict_xiju[j_num]=dict['url']
           j_num += 1
           url_dict_xiju.append(dict['url'])
           title_dict_xiju.append(dict['title'])
           # print(dict['url'])
           print(url_dict_xiju)
           # 打印url地址
           # print(title_dict_xiju)
       return url_dict_xiju
