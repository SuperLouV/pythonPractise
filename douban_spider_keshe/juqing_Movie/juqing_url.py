...
def get_juqing_url_list():
    ...
    base_url1 = "https://movie.douban.com/j/chart/top_list?type=11&interval_id=80%3A70&action=&start={}&limit=20"  # 80-70的影片
    base_url2 = "https://movie.douban.com/j/chart/top_list?type=11&interval_id=70%3A60&action=&start={}&limit=20"
    base_url3 = "https://movie.douban.com/j/chart/top_list?type=11&interval_id=60%3A50&action=&start={}&limit=20"
    base_url4 = "https://movie.douban.com/j/chart/top_list?type=11&interval_id=50%3A40&action=&start={}&limit=20"
    base_url5 = "https://movie.douban.com/j/chart/top_list?type=11&interval_id=40%3A30&action=&start={}&limit=20"
    base_url6 = "https://movie.douban.com/j/chart/top_list?type=11&interval_id=30%3A20&action=&start={}&limit=20"
    base_url7 = "https://movie.douban.com/j/chart/top_list?type=11&interval_id=20%3A10&action=&start={}&limit=20"
    base_url8 = "https://movie.douban.com/j/chart/top_list?type=11&interval_id=10%3A0&action=&start={}&limit=20"
    base_url = [base_url1, base_url2, base_url3, base_url4, base_url5, base_url6, base_url7, base_url8, base_url9,
                base_url10, ]
    # print(base_url)
    num = 0
    juqing_Movie = []
    while num <= 20:  # num从0 意味着一共20部电影,一般都是每个段位600多电影  正常580
        i = 0
        while i <= 2:#第一次设置为2  从80-0开始第二次 4.11
            # //////////////////////////////////////////////////////////////////构建代理
