import pandas as pd
import numpy as np
df=pd.read_csv(r'D:\pythonPractise\douban_spider_keshe\xuanyi_Movie\doubanxuanyi1000.csv',encoding='utf-8',header=None,names=['a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q'])
